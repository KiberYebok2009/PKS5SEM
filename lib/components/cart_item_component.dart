      ...
      child: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(top: 0, bottom:0, left:16, right:2),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Padding(
                    ...
                    IconButton(
                      onPressed: onRemove, 
                      icon: Image.asset('../Delete.png', height: 20, width: 20,),
                    )
                  ],
                ),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 0, bottom:16, left:16, right:4),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Padding(
                      ...
                      child: SizedBox(width: 60,
                        child: Text('${cartModel.price} ₽', textAlign: TextAlign.left, 
                        ...
                        children: [
                          Padding(
                            ...
                            child: SizedBox(width: 75,
                              child: Text('${cartModel.count} пациент', textAlign: TextAlign.left, 
